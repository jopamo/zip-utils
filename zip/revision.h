...
ZCONST char* far versinfolines[] = {"%s %s (%s) derived from %s Zip.",
...
ZCONST char* far cryptnote[] = {"Encryption notice:",
...
ZCONST char* far swlicense[] = {"Copyright (c) 1990-2008 Info-ZIP.  All rights reserved.",
                                "",
