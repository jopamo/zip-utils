...
#ifndef zcalloc
#define zcalloc(items, size) (zvoid far*)calloc((unsigned)(items), (unsigned)(size))
#endif
#ifndef zcfree
#define zcfree free
#endif
...
#ifdef TIMESTAMP
int get_time_stamp OF((__GPRO__ time_t* last_modtime, ulg* nmember));
#endif
...
#endif
#ifdef NO_STRNICMP
int zstrnicmp OF((register ZCONST char* s1, register ZCONST char* s2, register unsigned n));
#endif
#ifdef REGULUS
...
int memcmp OF((register ZCONST zvoid*, register ZCONST zvoid*, register unsigned int));
zvoid* memcpy OF((register zvoid*, register ZCONST zvoid*, register unsigned int));
#endif
#ifdef NEED_UZMBCLEN
...
int unzipToMemory OF((__GPRO__ char* zip, char* file, UzpBuffer* retstr)); /* api.c */
int redirect_outfile OF((__GPRO));                                         /* api.c */
int writeToMemory OF((__GPRO__ ZCONST uch * rawbuf, extent size));         /* api.c */
...
#ifdef FUNZIP
#define Info(buf, flag, sprf_arg) fputs((char*)(sprintf sprf_arg, (buf)), (flag) & 1 ? stderr : stdout)
#else
#ifdef INT_SPRINTF /* optimized version for "int sprintf()" flavour */
#define Info(buf, flag, sprf_arg) (*G.message)((zvoid*)&G, (uch*)(buf), (ulg)sprintf sprf_arg, (flag))
#else /* generic version, does not use sprintf() return value */
#define Info(buf, flag, sprf_arg) (*G.message)((zvoid*)&G, (uch*)(buf), (ulg)(sprintf sprf_arg, strlen((char*)(buf))), (flag))
#endif
#endif
#endif /* !Info */
 ...
 */
#define FnFilter1(fname) fnfilter((fname), slide + (extent)(WSIZE >> 1), (extent)(WSIZE >> 2))
#define FnFilter2(fname) fnfilter((fname), slide + (extent)((WSIZE >> 1) + (WSIZE >> 2)), (extent)(WSIZE >> 2))
...
#define SYMLINK_HOST(hn) ((hn) == UNIX_ || (hn) == ATARI_ || (hn) == ATHEOS_ || (hn) == BEOS_ || (hn) == VMS_)
#endif
...
#else
#define FLUSH(w) ((G.mem_mode) ? memflush(__G__ redirSlide, (ulg)(w)) : flush(__G__ redirSlide, (ulg)(w), 0))
...
#define Ext_ASCII_TO_Native(string, hostnum, hostver, isuxatt, islochdr)                                                                                                                            \
    if (((hostnum) == FS_FAT_ && !(((islochdr) || (isuxatt)) && ((hostver) == 25 || (hostver) == 26 || (hostver) == 40))) || (hostnum) == FS_HPFS_ || ((hostnum) == FS_NTFS_ && (hostver) == 50)) { \
        _OEM_INTERN((string));                                                                                                                                                                      \
    }                                                                                                                                                                                               \
    else {                                                                                                                                                                                          \
        _ISO_INTERN((string));                                                                                                                                                                      \
...
#define utf8_to_escaped_string(utf8_string) utf8_to_local_string(utf8_string, TRUE)
